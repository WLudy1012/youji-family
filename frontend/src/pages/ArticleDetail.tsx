...
export default function ArticleDetail() {
  ...
  if (!article) {
    return (
      <div className="text-center py-20">
        ...
        <Link to="/articles" className="text-[var(--primary)] hover:underline mt-4 inline-block">
          返回文章列表
        </Link>
      </div>
    )
  ...
  return (
    <div>
      <Link to="/articles" className="flex items-center text-[var(--primary)] hover:text-[var(--accent)] mb-6">
      ...
      <article className="card overflow-hidden">
        ...
        <div className="p-8">
          ...
          {/* 标题 */}
          <h1 className="text-3xl font-bold text-[var(--primary)] mb-6">{article.title}</h1>
          ...
          {/* 正文 */}
          <div
            className="prose prose-lg max-w-none prose-headings:text-[var(--primary)] prose-a:text-[var(--accent)]"
