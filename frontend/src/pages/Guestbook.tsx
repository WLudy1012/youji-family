  ...
  return (
    <div>
      ...
      <div className="card p-6 mb-8">
        <h2 className="text-lg font-semibold text-[var(--primary)] mb-4 flex items-center">
            ...
            {messages.map((msg) => (
              <div key={msg.id} className="card p-6">
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 w-10 h-10 bg-[var(--primary)] rounded-full flex items-center justify-center text-white">
                    <User className="w-5 h-5" />
                  </div>
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="font-semibold text-[var(--primary)]">{msg.author_name || '匿名'}</span>
                    ...
                    {/* 管理员回复 */}
                    {msg.reply_content && (
                      <div className="mt-4 bg-[var(--primary)]/5 p-4 rounded-lg">
                        <p className="text-sm text-[var(--primary)] font-medium mb-1">管理员回复：</p>
