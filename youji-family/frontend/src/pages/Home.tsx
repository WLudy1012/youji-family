...
import { ChevronRight, Users, BookOpen, Image, MessageSquare } from 'lucide-react'
...
export default function Home() {
  ...
  const loadHomeData = async () => {
    try {
      setLoading(true)
      const [configRes, announceRes, memberRes, articleRes, albumRes] = await Promise.all([
        getConfigs(),
      ...
      setData({
        ...
        announcements: (announceRes as any).data?.data || [],
        members: (memberRes as any).data?.data || [],
        articles: (articleRes as any).data?.data || [],
        albums: (albumRes as any).data?.data || []
      })
    } catch (error) {
